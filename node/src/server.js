...
const i_env = {
   debug: !!process.env.ZOEKT_DEBUG,
   server: {
      host: process.env.ZOEKT_HOST || '127.0.0.1',
      port: parseInt(process.env.ZOEKT_PORT || '8080'),
      staticDir: (
         process.env.ZOEKT_STATIC_DIR?
         i_path.resolve(process.env.ZOEKT_STATIC_DIR):null
      ),
      httpsCADir: (
         process.env.ZOEKT_HTTPS_CA_DIR?
         i_path.resolve(process.env.ZOEKT_HTTPS_CA_DIR):null
      ),
   },
};
